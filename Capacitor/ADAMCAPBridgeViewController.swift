...
open class ADAMCAPBridgeViewController: UIViewController, CAPBridgeDelegate, WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate {
  ...
  func loadWebView() {
    ...
    public func loadWebViewADAM(urlToLoad: String) {
//      let fullStartPath = URL(fileURLWithPath: assetsFolder).appendingPathComponent(startDir).appendingPathComponent("index")
//      if Bundle.main.path(forResource: fullStartPath.relativePath, ofType: "html") == nil {
//        fatalLoadError()
//      }
